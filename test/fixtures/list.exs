defmodule Geolix.TestFixtures.List do
  ...
  def get() do
    [
      ...
      { :fixture_enterprise, "GeoIP2-Enterprise-Test.mmdb", "https://raw.githubusercontent.com/maxmind/MaxMind-DB/master/test-data/GeoIP2-Enterprise-Test.mmdb" },
      ...
      { :fixture_decoder, "MaxMind-DB-test-decoder.mmdb", "https://raw.githubusercontent.com/maxmind/MaxMind-DB/master/test-data/MaxMind-DB-test-decoder.mmdb" },
